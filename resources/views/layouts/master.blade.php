...
<ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right" style="left: inherit; right: 0px;">
          ...
          @if($unassignedtickets >= 1)
          <a href="{{('assignedticket-datatable')}}" class="dropdown-item">
            <i class="fas fa-envelope mr-2"></i> {{$unassignedtickets}} unassigned tickets
            <span class="float-right text-muted text-sm">Assign</span>
          </a>
          @else
          @endif
          <div class="dropdown-divider"></div>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right" style="left: inherit; right: 0px;">
          ...
          <a href="#" class="dropdown-item">
            <i class="fas fa-envelope mr-2"></i> {{$technicianpendingtickets}} pending tickets
