...
@endif
<div class="card-body">
<table class="table table-bordered" id="myclosedticket-datatable">
<thead>
<tr>
<th>Id</th>
<th>Subject</th>
...
<!-- boostrap myclosedticket model -->
<div class="modal fade" id="myclosedticket-modal" aria-hidden="true">
<div class="modal-dialog modal-lg">
<div class="modal-content">
<div class="modal-header">
<h4 class="modal-title" id="MyClosedTicketModal"></h4>
</div>
<div class="modal-body">
<form action="javascript:void(0)" id="MyClosedTicketForm" name="MyClosedTicketForm" class="form-horizontal" method="POST" enctype="multipart/form-data">
...
$('#myclosedticket-datatable').DataTable({
processing: true,
serverSide: true,
ajax: "{{ url('myclosedticket-datatable') }}",
columns: [
{ data: 'id', name: 'id' },
