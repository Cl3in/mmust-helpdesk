...
@section('title', 'My Pending Tickets')
...
@endif
<div class="card-body">
<table class="table table-bordered" id="mypendingticket-datatable">
<thead>
<tr>
<th>Id</th>
<th>Subject</th>
...
<!-- boostrap mypendingticket model -->
<div class="modal fade" id="mypendingticket-modal" aria-hidden="true">
<div class="modal-dialog modal-lg">
<div class="modal-content">
<div class="modal-header">
<h4 class="modal-title" id="MyPendingTicketModal"></h4>
</div>
<div class="modal-body">
<form action="javascript:void(0)" id="MyPendingTicketForm" name="MyPendingTicketForm" class="form-horizontal" method="POST" enctype="multipart/form-data">
...
$('#mypendingticket-datatable').DataTable({
processing: true,
serverSide: true,
ajax: "{{ url('mypendingticket-datatable') }}",
columns: [
{ data: 'id', name: 'id' },
...
$('#MyPendingTicketForm').submit(function(e) {
e.preventDefault();
